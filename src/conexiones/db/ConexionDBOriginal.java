...
cn = DriverManager.getConnection("jdbc:mysql://"+cargaConfig()+"/admindcr?allowPublicKeyRetrieval=true&useSSL=false&useTimezone=true&serverTimezone=UTC","root","0ehn4TNU5R");//0ehn4TNU5I +cargaConfig()+
